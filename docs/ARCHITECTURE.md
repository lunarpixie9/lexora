...
| speech | passage word mismatch · rate below class reference · long pauses | 0.10 · 0.05 · 0.05 |
...
* ASER audio is phone-quality AMR-WB; Whisper is unreliable on isolated letters (recall 0.33 on capitals), so letter items rely on examiner marking.
